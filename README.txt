...
=== To process the data ====
   ...
   java -cp 'dist/gtcrawler.jar:dist/lib/*' main.Processor --folder <download_folder> --congress <congress_number> --processed-folder <process_folder> --addinfo-folder <external_file_folder>
